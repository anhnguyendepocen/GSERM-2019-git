...
CFURL<-"https://raw.githubusercontent.com/PrisonRodeo/GSERM-2019-git/master/Data/ceasefiresTC.csv"
temp<-getURL(CFURL)
...
LNBURL<-"https://raw.githubusercontent.com/PrisonRodeo/GSERM-2019-git/master/Data/LNB.csv"
temp<-getURL(LNBURL)
...
leadURL<-"https://raw.githubusercontent.com/PrisonRodeo/GSERM-2019-git/master/Data/leaders.csv"
temp<-getURL(leadURL)
