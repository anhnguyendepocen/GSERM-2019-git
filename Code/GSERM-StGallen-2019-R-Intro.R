...
#
# File last updated June 16, 2019
###############################################
#
# Basics: OBJECTS
#
...
setwd("~/Dropbox (Personal)/GSERM/Materials 2019/Data")
...
url <- getURL("https://raw.githubusercontent.com/PrisonRodeo/GSERM-2019-git/master/Data/SCOTUS-votes.csv")
